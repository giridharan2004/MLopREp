import { B as isCloudWorkstation, C as LogLevel, D as FirebaseError, I as getGlobal, J as isSafariOrWebkit, L as getModularInstance, P as getDefaultEmulatorHostnameAndPort, R as getUA, T as Component, W as isIndexedDBAvailable, Y as pingServer, c as _getProvider, f as _registerComponent, g as getApp, j as deepEqual, k as createMockUserToken, n as SDK_VERSION, p as _removeServiceInstance, q as isSafari, u as _isFirebaseServerApp, w as Logger, x as registerVersion } from "./index.esm-DbJm-43t.js";
//#region ../../../../node_modules/.pnpm/@firebase+webchannel-wrapper@1.0.6/node_modules/@firebase/webchannel-wrapper/dist/bloom-blob/esm/bloom_blob_es2018.js
...
//#endregion
//#region ../../../../node_modules/.pnpm/@firebase+webchannel-wrapper@1.0.6/node_modules/@firebase/webchannel-wrapper/dist/webchannel-blob/esm/webchannel_blob_es2018.js
...
//#endregion
//#region ../../../../node_modules/.pnpm/@firebase+firestore@4.15.0_@firebase+app@0.14.13/node_modules/@firebase/firestore/dist/common-b3e8012f.esm.js
/**
* @license
...
*/ function __PRIVATE_computeTransformOperationBaseValue(e, t) {
	return e instanceof __PRIVATE_NumericIncrementTransformOperation ? __PRIVATE_isNumber(t) ? t : { integerValue: 0 } : null;
}
...
/** Tracks the internal state of a Watch target. */ var __PRIVATE_TargetState = class {
	...
	*/
	constructor(e) {
		this.targetId = e, this.ve = 0, this.Fe = __PRIVATE_snapshotChangesMap(), this.Me = ByteString.EMPTY_BYTE_STRING, this.xe = !1, this.Oe = !0;
	}
	/**
...
*/ var __PRIVATE_WatchChangeAggregator = class {
		...
		this.forEachTarget(e, ((t) => {
			...
			if (n) switch (e.state) {
				...
				case 3:
					...
					break;
				case 4:
					this.nt(t) && (this.rt(t), n.Le(e.resumeToken));
					break;
	...
	*/ it(e) {
		...
		if (r) {
			...
			if (__PRIVATE_targetIsDocumentTarget(i)) if (0 === n) {
				...
				const r = this.ot(t);
				if (r !== n) {
					const n = this._t(e), i = n ? this.ut(n, e, r) : 1;
					if (0 !== i) {
						this.rt(t);
	...
	*/
	et(e, t, n) {
		...
		r && this.nt(e) ? (this.It(e, t) ? r.Ke(t, 1) : r.Ue(t), this.He = this.He.insert(t, this.Et(t).delete(e)), this.He = this.He.insert(t, this.Et(t).add(e)), n && (this.je = this.je.insert(t, n))) : __PRIVATE_logDebug(mt, `removeDocumentFromTarget received document for unknown or inactive target (${e})`);
	}
	removeTarget(e) {
		this.ze.delete(e);
	}
...
function __PRIVATE_fromWatchChange(e, t) {
	...
	if ("targetChange" in t) {
		...
		if (!("filter" in t)) return fail(11601, { At: t });
		{
			t.filter;
			const e = t.filter;
			e.targetId;
...
function __PRIVATE_fromMutation(e, t) {
	const n = t.currentDocument ? function __PRIVATE_fromPrecondition(e) {
		...
		else "increment" in t ? n = new __PRIVATE_NumericIncrementTransformOperation(e, t.increment) : "minimum" in t ? n = new __PRIVATE_NumericMinimumTransformOperation(e, t.minimum) : "maximum" in t ? n = new __PRIVATE_NumericMaximumTransformOperation(e, t.maximum) : fail(16584, { proto: t });
...
var __PRIVATE_FirestoreIndexValueWriter = class {
	...
	Dt(e, t) {
		if ("nullValue" in e) this.vt(t, 5);
			...
			isNaN(n) ? this.vt(t, 13) : (this.vt(t, 15), __PRIVATE_isNegativeZero(n) ? t.Ft(0) : t.Ft(n));
		...
		} else "mapValue" in e ? __PRIVATE_isMaxValue(e) ? this.vt(t, Number.MAX_SAFE_INTEGER) : __PRIVATE_isVectorValue(e) ? this.Lt(e.mapValue, t) : (this.kt(e.mapValue, t), this.Ot(t)) : "arrayValue" in e ? (this.qt(e.arrayValue, t), this.Ot(t)) : fail(19022, { Kt: e });
	}
	xt(e, t) {
	...
	Lt(e, t) {
		...
		this.vt(t, 15), t.Ft(__PRIVATE_normalizeNumber(i)), this.xt(r, t), this.Dt(n[r], t);
	}
	qt(e, t) {
		const n = e.values || [];
		this.vt(t, 50);
...
*/ var __PRIVATE_OrderedCodeWriter = class {
	...
	/** Writes utf8 bytes into this byte sequence, ascending. */ Ht(e) {
		for (const t of e) {
			...
			if (e < 128) this.Qt(e);
			else if (e < 2048) this.Qt(960 | e >>> 6), this.Qt(128 | 63 & e);
			else if (t < "\ud800" || "\udbff" < t) this.Qt(480 | e >>> 12), this.Qt(128 | 63 & e >>> 6), this.Qt(128 | 63 & e);
			else {
				const e = t.codePointAt(0);
				this.Qt(240 | e >>> 18), this.Qt(128 | 63 & e >>> 12), this.Qt(128 | 63 & e >>> 6), this.Qt(128 | 63 & e);
			}
		}
		this.Gt();
	}
	...
	*/ Yt(e) {
	...
	/** Writes a single byte ascending to the buffer. */ Qt(e) {
		const t = 255 & e;
...
/** Represents an index entry saved by the SDK in persisted storage. */ var __PRIVATE_IndexEntry = class __PRIVATE_IndexEntry {
	...
	*/ In() {
		...
		return n.set(this.Tn, 0), t !== e ? n.set([0], this.Tn.length) : ++n[n.length - 1], new __PRIVATE_IndexEntry(this.ln, this.hn, this.Pn, n);
	}
	En(e, t, n) {
		return {
			indexId: this.ln,
...
var __PRIVATE_TargetIndexMatcher = class {
	constructor(e) {
		this.An = new SortedSet(((e, t) => FieldPath$1.comparator(e.field, t.field))), this.collectionId = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment(), this.Vn = e.orderBy, this.dn = [];
		for (const t of e.filters) {
			const e = t;
			e.isInequality() ? this.An = this.An.add(e) : this.dn.push(e);
		}
	}
	get mn() {
	...
	*   omitted.
	*/ fn(e) {
		if (__PRIVATE_hardAssert(e.collectionGroup === this.collectionId, 49279), this.mn) return !1;
		const t = __PRIVATE_fieldIndexGetArraySegment(e);
		if (void 0 !== t && !this.gn(t)) return !1;
		...
		if (this.An.size > 0) {
			const e = this.An.getIterator().getNext();
			if (!r.has(e.field.canonicalString())) {
				const t = n[i];
				if (!this.pn(e, t) || !this.yn(this.Vn[s++], t)) return !1;
			}
			++i;
		}
		for (; i < n.length; ++i) {
			const e = n[i];
			if (s >= this.Vn.length || !this.yn(this.Vn[s++], e)) return !1;
		}
		return !0;
	}
	/**
	...
	*/ wn() {
		...
		for (const n of this.Vn) n.field.isKeyField() || e.has(n.field) || (e = e.add(n.field), t.push(new IndexSegment(n.field, "asc" === n.dir ? 0 : 1)));
		return new FieldIndex(FieldIndex.UNKNOWN_ID, this.collectionId, t, IndexState.empty());
	}
	gn(e) {
		for (const t of this.dn) if (this.pn(t, e)) return !0;
		return !1;
	}
	pn(e, t) {
...
var __PRIVATE_IndexedDbIndexManager = class {
	constructor(e, t) {
		this.databaseId = t, this.bn = new __PRIVATE_MemoryCollectionParentIndex(), this.Dn = new ObjectMap(((e) => __PRIVATE_canonifyTarget(e)), ((e, t) => __PRIVATE_targetEquals(e, t))), this.uid = e.uid || "";
	}
	/**
	...
	*/ addToCollectionParentIndex(e, t) {
	...
	createTargetIndexes(e, t) {
		return PersistencePromise.forEach(this.Cn(t), ((t) => this.getIndexType(e, t).next(((n) => {
			if (0 === n || 1 === n) {
				const n = new __PRIVATE_TargetIndexMatcher(t).wn();
	...
	getDocumentsMatchingTarget(e, t) {
		...
		return PersistencePromise.forEach(this.Cn(t), ((t) => this.vn(e, t).next(((e) => {
			r && (r = !!e), i.set(t, e);
		})))).next((() => {
			if (r) {
				...
				return PersistencePromise.forEach(i, ((i, s) => {
					...
					const o = function __PRIVATE_targetGetArrayValues(e, t) {
						...
						return new Bound(n, r);
					}(s, i), c = this.Fn(i, s, a), l = this.Fn(i, s, u), h = this.Mn(i, s, _), P = this.xn(i.indexId, o, c, a.inclusive, l, u.inclusive, h);
	...
	*/ xn(e, t, n, r, i, s, o) {
		...
		for (let c = 0; c < _; ++c) {
			const _ = t ? this.On(t[c / a]) : bt, l = this.Nn(e, _, n[c % a], r), h = this.Bn(e, _, i[c % a], s), P = o.map(((t) => this.Nn(e, _, t, !0)));
			u.push(...this.createRange(l, h, P));
		}
		return u;
	}
	/** Generates the lower bound for `arrayValue` and `directionalValue`. */ Nn(e, t, n, r) {
		const i = new __PRIVATE_IndexEntry(e, DocumentKey.empty(), t, n);
		return r ? i : i.In();
	}
	/** Generates the upper bound for `arrayValue` and `directionalValue`. */ Bn(e, t, n, r) {
		const i = new __PRIVATE_IndexEntry(e, DocumentKey.empty(), t, n);
		return r ? i.In() : i;
	}
	vn(e, t) {
		...
		return this.getFieldIndexes(e, r).next(((e) => {
			let t = null;
			for (const r of e) n.fn(r) && (!t || r.fields.length > t.fields.length) && (t = r);
			return t;
		}));
	}
	getIndexType(e, t) {
		let n = 2;
		const r = this.Cn(t);
		return PersistencePromise.forEach(r, ((t) => this.vn(e, t).next(((e) => {
	...
	*/ Ln(e, t) {
		...
		for (const r of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
			...
			if (null == e) return null;
			const i = n.cn(r.kind);
			__PRIVATE_FirestoreIndexValueWriter.$t.bt(e, i);
		}
		return n.an();
	}
	/** Encodes a single value to the ascending index format. */ On(e) {
		const t = new __PRIVATE_IndexByteEncoder();
		return __PRIVATE_FirestoreIndexValueWriter.$t.bt(e, t.cn(0)), t.an();
	}
	/**
	...
	*/ kn(e, t) {
		const n = new __PRIVATE_IndexByteEncoder();
		return __PRIVATE_FirestoreIndexValueWriter.$t.bt(__PRIVATE_refValue(this.databaseId, t), n.cn(function __PRIVATE_fieldIndexGetKeyOrder(e) {
	...
	*/ Mn(e, t, n) {
		...
		for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
			const e = n[i++];
			for (const n of r) if (this.qn(t, s.fieldPath) && isArray(e)) r = this.Kn(r, s, e);
			else {
				const t = n.cn(s.kind);
				__PRIVATE_FirestoreIndexValueWriter.$t.bt(e, t);
			}
		}
		return this.Un(r);
	}
	...
	*/ Fn(e, t, n) {
	...
	/** Returns the byte representation for the provided encoders. */ Un(e) {
		const t = [];
	...
	*/ Kn(e, t, n) {
		...
		for (const e of n.arrayValue.values || []) for (const n of r) {
			...
			r.seed(n.an()), __PRIVATE_FirestoreIndexValueWriter.$t.bt(e, r.cn(t.kind)), i.push(r);
		}
		return i;
	}
	qn(e, t) {
	...
	updateCollectionGroup(e, t, n) {
		...
		return this.$n(e).next(((e) => r.J(be, IDBKeyRange.bound(t, t)).next(((t) => PersistencePromise.forEach(t, ((t) => i.put(__PRIVATE_toDbIndexState(t.indexId, this.uid, e, n))))))));
	}
	updateIndexEntries(e, t) {
		const n = /* @__PURE__ */ new Map();
		return PersistencePromise.forEach(t, ((t, r) => {
			...
			return (i ? PersistencePromise.resolve(i) : this.getFieldIndexes(e, t.collectionGroup)).next(((i) => (n.set(t.collectionGroup, i), PersistencePromise.forEach(i, ((n) => this.Wn(e, t, n).next(((t) => {
				const i = this.Qn(r, n);
				return t.isEqual(i) ? PersistencePromise.resolve() : this.Gn(e, r, n, t, i);
			})))))));
		}));
	}
	zn(e, t, n, r) {
	...
	/** Creates the index entries for the given document. */ Qn(e, t) {
		...
		if (null != i) {
			...
			if (isArray(s)) for (const i of s.arrayValue.values || []) n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.On(i), r));
	...
	*/ createRange(e, t, n) {
		...
		for (let e = 0; e < r.length; e += 2) {
			...
			const t = r[e].Rn(this.uid, bt, DocumentKey.empty()), n = r[e + 1].Rn(this.uid, bt, DocumentKey.empty());
	...
	getMinOffset(e, t) {
		return PersistencePromise.mapArray(this.Cn(t), ((t) => this.vn(e, t).next(((e) => e || fail(44426))))).next(__PRIVATE_getMinOffsetFromFieldIndexes);
	}
};
/**
...
var __PRIVATE_IndexedDbMutationQueue = class __PRIVATE_IndexedDbMutationQueue {
	constructor(e, t, n, r) {
		this.userId = e, this.serializer = t, this.indexManager = n, this.referenceDelegate = r, this.Hn = {};
	}
	/**
	...
	*/
	Zn(e, t) {
		return this.Hn[t] ? PersistencePromise.resolve(this.Hn[t]) : this.lookupMutationBatch(e, t).next(((e) => {
			if (e) {
				const n = e.keys();
	...
	getNextMutationBatchAfterBatchId(e, t) {
		...
		return __PRIVATE_mutationsStore(e).ee({
			...
			t.userId === this.userId && (__PRIVATE_hardAssert(t.batchId >= n, 47524, { Xn: n }), i = __PRIVATE_fromDbMutationBatch(this.serializer, t)), r.done();
		})).next((() => i));
	}
	...
	performConsistencyCheck(e) {
		return this.checkEmpty(e).next(((t) => {
			...
			return __PRIVATE_documentMutationsStore(e).ee({ range: n }, ((e, t, n) => {
				...
				__PRIVATE_hardAssert(0 === r.length, 56720, { nr: r.map(((e) => e.canonicalString())) });
			}));
		}));
	}
	containsKey(e, t) {
...
*/ var __PRIVATE_IndexedDbTargetCache = class {
	...
	allocateTargetId(e) {
		return this.ar(e).next(((t) => {
			return t.highestTargetId = new __PRIVATE_TargetIdGenerator(t.highestTargetId).next(), this.ur(e, t).next((() => t.highestTargetId));
		}));
	}
	getLastRemoteSnapshotVersion(e) {
		return this.ar(e).next(((e) => SnapshotVersion.fromTimestamp(new Timestamp(e.lastRemoteSnapshotVersion.seconds, e.lastRemoteSnapshotVersion.nanoseconds))));
	}
	getHighestSequenceNumber(e) {
		return this.ar(e).next(((e) => e.highestListenSequenceNumber));
	}
	...
	removeTargetData(e, t) {
		return this.removeMatchingKeysForTargetId(e, t.targetId).next((() => __PRIVATE_targetsStore(e).delete(t.targetId))).next((() => this.ar(e))).next(((t) => (__PRIVATE_hardAssert(t.targetCount > 0, 8065), t.targetCount -= 1, this.ur(e, t))));
	}
	/**
	...
	*/ lr(e, t) {
	...
	getTargetCount(e) {
		return this.ar(e).next(((e) => e.targetCount));
	}
	getTargetData(e, t) {
...
*/ var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
	...
	*/
	constructor(e, t) {
		super(), this.Fr = e, this.trackRemovals = t, this.Mr = new ObjectMap(((e) => e.toString()), ((e, t) => e.isEqual(t)));
	}
	applyChanges(e) {
		const t = [];
		...
		return this.changes.forEach(((i, s) => {
			...
			if (t.push(this.Fr.removeEntry(e, i, o.readTime)), s.isValidDocument()) {
				...
				const n = __PRIVATE_toDbRemoteDocument(this.Fr.serializer, s.convertToNoDocument(SnapshotVersion.min()));
				t.push(this.Fr.addEntry(e, i, n));
			}
		})), r.forEach(((n) => {
			t.push(this.Fr.indexManager.addToCollectionParentIndex(e, n));
		})), t.push(this.Fr.updateMetadata(e, n)), PersistencePromise.waitFor(t);
	}
	getFromCache(e, t) {
		return this.Fr.br(e, t).next(((e) => (this.Mr.set(t, {
			size: e.size,
			readTime: e.document.readTime
		}), e.document)));
	}
	getAllFromCache(e, t) {
		return this.Fr.Cr(e, t).next((({ documents: e, vr: t }) => (t.forEach(((t, n) => {
			this.Mr.set(t, {
				size: n,
...
*/ var __PRIVATE_MemoryDocumentOverlayCache = class {
	...
	removeOverlaysForBatchId(e, t, n) {
		...
		return void 0 !== r && (r.forEach(((e) => this.overlays = this.overlays.remove(e))), this.Br.delete(n)), PersistencePromise.resolve();
	}
	getOverlaysForCollection(e, t, n) {
...
*/ var __PRIVATE_ReferenceSet = class {
	constructor() {
		this.Lr = new SortedSet(__PRIVATE_DocReference.kr), this.qr = new SortedSet(__PRIVATE_DocReference.Kr);
	}
...
*/ var __PRIVATE_MemoryMutationQueue = class {
	constructor(e, t) {
		this.indexManager = e, this.referenceDelegate = t, this.mutationQueue = [], this.Xn = 1, this.Jr = new SortedSet(__PRIVATE_DocReference.kr);
	}
	checkEmpty(e) {
...
var __PRIVATE_MemoryRemoteDocumentCacheImpl = class {
	...
	*/
	constructor(e) {
		this.ei = e, this.docs = function __PRIVATE_documentEntryMap() {
			return new SortedMap(DocumentKey.comparator);
		}(), this.size = 0;
	}
	setIndexManager(e) {
...
*/ var __PRIVATE_MemoryTargetCache = class {
	constructor(e) {
		this.persistence = e, this.ni = new ObjectMap(((e) => __PRIVATE_canonifyTarget(e)), __PRIVATE_targetEquals), this.lastRemoteSnapshotVersion = SnapshotVersion.min(), this.highestTargetId = 0, this.ri = 0, this.ii = new __PRIVATE_ReferenceSet(), this.targetCount = 0, this.si = __PRIVATE_TargetIdGenerator.sr();
	}
	forEachTarget(e, t) {
...
var __PRIVATE_MemoryPersistence = class {
	...
	*/
	constructor(e, t) {
		this.oi = {}, this.overlays = {}, this._i = new __PRIVATE_ListenSequence(0), this.ai = !1, this.ai = !0, this.ui = new __PRIVATE_MemoryGlobalsCache(), this.referenceDelegate = e(this), this.ci = new __PRIVATE_MemoryTargetCache(this);
		...
		}(((e) => this.referenceDelegate.li(e))), this.serializer = new __PRIVATE_LocalSerializer(t), this.hi = new __PRIVATE_MemoryBundleCache(this.serializer);
	}
	start() {
		return Promise.resolve();
	}
	shutdown() {
		return this.ai = !1, Promise.resolve();
	}
	get started() {
		return this.ai;
	}
	...
	runTransaction(e, t, n) {
		...
		return this.referenceDelegate.Pi(), n(r).next(((e) => this.referenceDelegate.Ti(r).next((() => e)))).toPromise().then(((e) => (r.raiseOnCommittedEvent(), e)));
	}
	Ii(e, t) {
...
var __PRIVATE_MemoryEagerDelegate = class __PRIVATE_MemoryEagerDelegate {
	constructor(e) {
		this.persistence = e, this.Ei = new __PRIVATE_ReferenceSet(), this.Ri = null;
	}
	static Ai(e) {
	...
	di(e, t) {
		return PersistencePromise.or([
			() => PersistencePromise.resolve(this.Ei.containsKey(t)),
...
var __PRIVATE_MemoryLruDelegate = class __PRIVATE_MemoryLruDelegate {
	constructor(e, t) {
		this.persistence = e, this.mi = new ObjectMap(((e) => __PRIVATE_encodeResourcePath(e.path)), ((e, t) => e.isEqual(t))), this.garbageCollector = __PRIVATE_newLruGarbageCollector(this, t);
	}
	static Ai(e, t) {
...
/** Performs database creation and schema upgrades. */ var __PRIVATE_SchemaConverter = class {
	...
	*/ k(e, t, n, r) {
		...
		}))), n < 5 && r >= 5 && (s = s.next((() => this.fi(i)))), n < 6 && r >= 6 && (s = s.next((() => (function __PRIVATE_createDocumentGlobalStore(e) {
		...
		}(e))).next((() => this.Si(e, i))).next((() => e.deleteObjectStore($)))), n < 14 && r >= 14 && (s = s.next((() => this.bi(e, i)))), n < 15 && r >= 15 && (s = s.next((() => function __PRIVATE_createFieldIndex(e) {
	...
	bi(e, t) {
		...
		return n.J().next(((e) => {
			...
			return e.forEach(((e) => {
				...
				const s = new User(n), o = __PRIVATE_IndexedDbDocumentOverlayCache.yt(this.serializer, s), _ = i.getIndexManager(s);
				return new LocalDocumentsView(r, __PRIVATE_IndexedDbMutationQueue.yt(s, this.serializer, _, i.referenceDelegate), o, _).recalculateAndSaveOverlaysForDocumentKeys(new __PRIVATE_IndexedDbTransaction(t, __PRIVATE_ListenSequence.ce), e).next();
			}));
		}));
	}
};
...
var __PRIVATE_IndexedDbPersistence = class __PRIVATE_IndexedDbPersistence {
	constructor(e, t, n, r, i, s, o, _, a, u, c = 18) {
		if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this.Di = i, this.window = s, this.document = o, this.Ci = a, this.Fi = u, this.Mi = c, this._i = null, this.ai = !1, this.isPrimary = !1, this.networkEnabled = !0, this.xi = null, this.inForeground = !1, this.Oi = null, this.Ni = null, this.Bi = Number.NEGATIVE_INFINITY, this.Li = (e) => Promise.resolve(), !__PRIVATE_IndexedDbPersistence.v()) throw new FirestoreError(D.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
		this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, r), this.ki = t + Nt, this.serializer = new __PRIVATE_LocalSerializer(_), this.qi = new __PRIVATE_SimpleDb(this.ki, this.Mi, new __PRIVATE_SchemaConverter(this.serializer)), this.ui = new __PRIVATE_IndexedDbGlobalsCache(), this.ci = new __PRIVATE_IndexedDbTargetCache(this.referenceDelegate, this.serializer), this.remoteDocumentCache = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), this.hi = new __PRIVATE_IndexedDbBundleCache(), this.window && this.window.localStorage ? this.Ki = this.window.localStorage : (this.Ki = null, !1 === u && __PRIVATE_logError(Ft, "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
	}
	/**
	...
	*/ start() {
		return this.Ui().then((() => {
			if (!this.isPrimary && !this.allowTabSynchronization) throw new FirestoreError(D.FAILED_PRECONDITION, Ot);
	...
	* PORTING NOTE: This is only used for Web multi-tab.
	*/ setNetworkEnabled(e) {
		this.networkEnabled !== e && (this.networkEnabled = e, this.Di.enqueueAndForget((async () => {
	...
	*/ Ui() {
		return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", ((e) => __PRIVATE_clientMetadataStore(e).put({
			...
			if (this.isPrimary) return this.zi(e).next(((e) => {
				e || (this.isPrimary = !1, this.Di.enqueueRetryable((() => this.Li(!1))));
			}));
		})).next((() => this.ji(e))).next(((t) => this.isPrimary && !t ? this.Ji(e).next((() => !1)) : !!t && this.Hi(e).next((() => !0)))))).catch(((e) => {
	...
	zi(e) {
		return __PRIVATE_primaryClientStore(e).get(Q).next(((e) => PersistencePromise.resolve(this.Zi(e))));
	}
	Xi(e) {
	...
	*/ async Yi() {
		if (this.isPrimary && !this.es(this.Bi, Mt)) {
			...
			const e = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", ((e) => {
				...
				return t.J().next(((e) => {
					const n = this.ts(e, Mt), r = e.filter(((e) => -1 === n.indexOf(e)));
	...
	*/ Qi() {
	...
	/** Checks whether `client` is the local client. */ Zi(e) {
	...
	*/ ji(e) {
		if (this.Fi) return PersistencePromise.resolve(!0);
		return __PRIVATE_primaryClientStore(e).get(Q).next(((t) => {
			if (null !== t && this.es(t.leaseTimestampMs, xt) && !this.rs(t.ownerId)) {
				if (this.Zi(t) && this.networkEnabled) return !0;
				if (!this.Zi(t)) {
					if (!t.allowTabSynchronization) throw new FirestoreError(D.FAILED_PRECONDITION, Ot);
					return !1;
				}
			}
			return !(!this.networkEnabled || !this.inForeground) || __PRIVATE_clientMetadataStore(e).J().next(((e) => void 0 === this.ts(e, xt).find(((e) => {
	...
	async shutdown() {
		this.ai = !1, this.ss(), this.Ni && (this.Ni.cancel(), this.Ni = null), this._s(), this.us(), await this.qi.runTransaction("shutdown", "readwrite", [W, Ve], ((e) => {
			const t = new __PRIVATE_IndexedDbTransaction(e, __PRIVATE_ListenSequence.ce);
			return this.Ji(t).next((() => this.Xi(t)));
		})), this.qi.close(), this.cs();
	}
	/**
	* Returns clients that are not zombied and have an updateTime within the
	* provided threshold.
	*/ ts(e, t) {
		return e.filter(((e) => this.es(e.updateTimeMs, t) && !this.rs(e.clientId)));
	}
	/**
	...
	* PORTING NOTE: This is only used for Web multi-tab.
	*/ ls() {
		return this.runTransaction("getActiveClients", "readonly", ((e) => __PRIVATE_clientMetadataStore(e).J().next(((e) => this.ts(e, Mt).map(((e) => e.clientId))))));
	}
	get started() {
		return this.ai;
	}
	...
	runTransaction(e, t, n) {
		...
		let s;
		return this.qi.runTransaction(e, r, i, ((r) => (s = new __PRIVATE_IndexedDbTransaction(r, this._i ? this._i.next() : __PRIVATE_ListenSequence.ce), "readwrite-primary" === t ? this.zi(s).next(((e) => !!e || this.ji(s))).next(((t) => {
			if (!t) throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = !1, this.Di.enqueueRetryable((() => this.Li(!1))), new FirestoreError(D.FAILED_PRECONDITION, B);
			return n(s);
		})).next(((e) => this.Hi(s).next((() => e)))) : this.hs(s).next((() => n(s)))))).then(((e) => (s.raiseOnCommittedEvent(), e)));
	}
	/**
	...
	*/
	hs(e) {
		return __PRIVATE_primaryClientStore(e).get(Q).next(((e) => {
			if (null !== e && this.es(e.leaseTimestampMs, xt) && !this.rs(e.ownerId) && !this.Zi(e) && !(this.Fi || this.allowTabSynchronization && e.allowTabSynchronization)) throw new FirestoreError(D.FAILED_PRECONDITION, Ot);
		}));
	}
	/**
	...
	*/ Hi(e) {
	...
	/** Checks the primary lease and removes it if we are the current primary. */ Ji(e) {
		...
		return t.get(Q).next(((e) => this.Zi(e) ? (__PRIVATE_logDebug(Ft, "Releasing primary lease."), t.delete(Q)) : PersistencePromise.resolve()));
	}
	/** Verifies that `updateTimeMs` is within `maxAgeMs`. */ es(e, t) {
		const n = Date.now();
	...
	*/ Wi() {
		"function" == typeof this.window?.addEventListener && (this.xi = () => {
			...
			isSafari() && (navigator.appVersion.match(e) || navigator.userAgent.match(e)) && this.Di.enterRestrictedMode(!0), this.Di.enqueueAndForget((() => this.shutdown()));
	...
	*/ ss() {
	...
	/** Removes the zombied client entry if it exists. */ cs() {
		if (this.Ki) try {
...
var __PRIVATE_QueryEngine = class {
	constructor() {
		this.Es = !1, this.Rs = !1, this.As = 100, this.Vs = function __PRIVATE_getDefaultRelativeIndexReadCostPerDocument() {
			return isSafari() ? 8 : __PRIVATE_getAndroidVersion(getUA()) > 0 ? 6 : 4;
		}();
	}
	/** Sets the document view to query against. */ initialize(e, t) {
		this.ds = e, this.indexManager = t, this.Es = !0;
	}
	...
	*/ fs(e, t) {
		...
		return this.indexManager.getIndexType(e, n).next(((r) => 0 === r ? null : (null !== t.limit && 1 === r && (t = __PRIVATE_queryWithLimit(t, null, "F"), n = __PRIVATE_queryToTarget(t)), this.indexManager.getDocumentsMatchingTarget(e, n).next(((r) => {
			...
			return this.ds.getDocuments(e, i).next(((r) => this.indexManager.getMinOffset(e, n).next(((n) => {
				const s = this.ws(t, r);
				return this.Ss(t, s, i, n.readTime) ? this.fs(e, __PRIVATE_queryWithLimit(t, null, "F")) : this.bs(e, s, t, n);
			}))));
		})))));
	}
	/**
	...
	*/ gs(e, t, n, r) {
		return __PRIVATE_queryMatchesAllDocuments(t) || r.isEqual(SnapshotVersion.min()) ? PersistencePromise.resolve(null) : this.ds.getDocuments(e, n).next(((i) => {
			const s = this.ws(t, i);
			return this.Ss(t, s, n, r) ? PersistencePromise.resolve(null) : (__PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "Re-using previous result from %s to execute query: %s", r.toString(), __PRIVATE_stringifyQuery(t)), this.bs(e, s, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, N)).next(((e) => e)));
		}));
	}
	...
	*/ bs(e, t, n, r) {
		return this.ds.getDocumentsMatchingQuery(e, n, r).next(((e) => (t.forEach(((t) => {
			e = e.insert(t.key, t);
		})), e)));
	}
};
...
var __PRIVATE_LocalStoreImpl = class {
	constructor(e, t, n, r) {
		this.persistence = e, this.Ds = t, this.serializer = r, this.Cs = new SortedMap(__PRIVATE_primitiveComparator), this.vs = new ObjectMap(((e) => __PRIVATE_canonifyTarget(e)), __PRIVATE_targetEquals), this.Fs = /* @__PURE__ */ new Map(), this.Ms = e.getRemoteDocumentCache(), this.ci = e.getTargetCache(), this.hi = e.getBundleCache(), this.xs(n);
	}
	xs(e) {
...
function __PRIVATE_localStoreAcknowledgeBatch(e, t) {
	...
	return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", ((e) => {
		const r = t.batch.keys(), i = n.Ms.newChangeBuffer({ trackRemovals: !0 });
...
*/ function __PRIVATE_localStoreApplyRemoteEventToLocalCache(e, t) {
	...
	return n.persistence.runTransaction("Apply remote event", "readwrite-primary", ((e) => {
		const s = n.Ms.newChangeBuffer({ trackRemovals: !0 });
		i = n.Cs;
		const o = [];
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
	...
	return n.persistence.runTransaction("Allocate target", "readwrite", ((e) => {
		let r;
		return n.ci.getTargetData(e, t).next(((i) => i ? (r = i, PersistencePromise.resolve(r)) : n.ci.allocateTargetId(e).next(((i) => (r = new TargetData(t, i, "TargetPurposeListen", e.currentSequenceNumber), n.ci.addTargetData(e, r).next((() => r)))))));
	})).then(((e) => {
		const r = n.Cs.get(e.targetId);
		return (null === r || e.snapshotVersion.compareTo(r.snapshotVersion) > 0) && (n.Cs = n.Cs.insert(e.targetId, e), n.vs.set(t, e.targetId)), e;
	}));
}
/**
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
	...
	return n.persistence.runTransaction("Get new document changes", "readonly", ((e) => n.Ms.getAllFromCollectionGroup(e, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, N), Number.MAX_SAFE_INTEGER))).then(((e) => (__PRIVATE_setMaxReadTime(n, t, e), e)));
}
...
async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r) {
	...
	const _ = i.Ms.newChangeBuffer({ trackRemovals: !0 }), a = await __PRIVATE_localStoreAllocateTarget(i, function __PRIVATE_umbrellaTarget(e) {
		return __PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(ResourcePath.fromString(`__bundle__/docs/${e}`)));
	}(r));
	return i.persistence.runTransaction("Apply bundle documents", "readwrite", ((e) => __PRIVATE_populateDocumentChangeBuffer(e, _, o).next(((t) => (_.apply(e), t))).next(((t) => i.ci.removeMatchingKeysForTargetId(e, a.targetId).next((() => i.ci.addMatchingKeys(e, s, a.targetId))).next((() => i.localDocuments.getLocalViewOfDocuments(e, t.Ns, t.Bs))).next((() => t.Ns))))));
}
/**
...
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
	...
	return i.persistence.runTransaction("Save named query", "readwrite", ((e) => {
		...
		if (r.snapshotVersion.compareTo(s) >= 0) return i.hi.saveNamedQuery(e, t);
		const o = r.withResumeToken(ByteString.EMPTY_BYTE_STRING, s);
		return i.Cs = i.Cs.insert(o.targetId, o), i.ci.updateTargetData(e, o).next((() => i.ci.removeMatchingKeysForTargetId(e, r.targetId))).next((() => i.ci.addMatchingKeys(e, n, r.targetId))).next((() => i.hi.saveNamedQuery(e, t)));
	}));
}
/**
* @license
...
*/ var __PRIVATE_WebStorageSharedClientState = class {
	constructor(e, t, n, r, i) {
		this.window = e, this.Di = t, this.persistenceKey = n, this.Gs = r, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.zs = this.js.bind(this), this.Js = new SortedMap(__PRIVATE_primitiveComparator), this.started = !1, this.Hs = [];
		const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
		this.storage = this.window.localStorage, this.currentUser = i, this.Zs = createWebStorageClientStateKey(this.persistenceKey, this.Gs), this.Xs = function createWebStorageSequenceNumberKey(e) {
			return `firestore_sequence_number_${e}`;
		}(this.persistenceKey), this.Js = this.Js.insert(this.Gs, new __PRIVATE_LocalClientState()), this.Ys = new RegExp(`^${kt}_${s}_([^_]*)$`), this.eo = new RegExp(`^${Kt$1}_${s}_(\\d+)(?:_(.*))?$`), this.no = new RegExp(`^${qt}_${s}_(\\d+)$`), this.ro = function createWebStorageOnlineStateKey(e) {
			return `firestore_online_state_${e}`;
		}(this.persistenceKey), this.io = function createBundleLoadedKey(e) {
			return `firestore_bundle_loaded_v2_${e}`;
		}(this.persistenceKey), this.window.addEventListener("storage", this.zs);
	}
	...
	async start() {
		...
		for (const e of this.Hs) this.js(e);
		this.Hs = [], this.window.addEventListener("pagehide", (() => this.shutdown())), this.started = !0;
	}
	...
	addLocalQueryTarget(e, t = !0) {
		...
		if (this.isActiveQueryTarget(e)) {
			...
			if (t) {
				const r = __PRIVATE_QueryTargetMetadata.Us(e, t);
				r && (n = r.state);
			}
		}
	...
	shutdown() {
		this.started && (this.window.removeEventListener("storage", this.zs), this.removeItem(this.Zs), this.started = !1);
	}
	getItem(e) {
	...
	js(e) {
		...
		if (t.storageArea === this.storage) {
			if (__PRIVATE_logDebug(Ut$1, "EVENT", t.key, t.newValue), t.key === this.Zs) return void __PRIVATE_logError("Received WebStorage notification for local change. Another client might have garbage-collected our state");
				...
				if (this.started) {
					if (null !== t.key) {
						if (this.Ys.test(t.key)) {
							...
							if (null !== t.newValue) {
								const e = this.oo(t.newValue);
								if (e) return this._o(e);
							}
							...
							const e = function __PRIVATE_fromWebStorageSequenceNumber(e) {
								...
								if (null != e) try {
									...
									__PRIVATE_hardAssert("number" == typeof n, 30636, { po: e }), t = n;
								} catch (e) {
							...
							const e = this.yo(t.newValue);
							await Promise.all(e.map(((e) => this.syncEngine.wo(e))));
						}
					}
				} else this.Hs.push(t);
			}));
...
var __PRIVATE_RestConnection = class {
	...
	$o(e, t, n, r, i) {
		...
		return this.Go(e, o, _, n, c).then(((t) => (__PRIVATE_logDebug(Qt, `Received RPC '${e}' ${s}: `, t), t)), ((t) => {
...
var __PRIVATE_WebChannelConnection = class __PRIVATE_WebChannelConnection extends __PRIVATE_RestConnection {
	constructor(e) {
		super(e), this.__ = [], this.forceLongPolling = e.forceLongPolling, this.autoDetectLongPolling = e.autoDetectLongPolling, this.useFetchStreams = e.useFetchStreams, this.longPollingOptions = e.longPollingOptions;
	}
	/**
	* Initialize STAT_EVENT listener once. Subsequent calls are a no-op.
	* getStatEventTarget() returns the same target every time.
	*/ static a_() {
		if (!__PRIVATE_WebChannelConnection.u_) __PRIVATE_unguardedEventListen(getStatEventTarget(), Event.STAT_EVENT, ((e) => {
		...
		})), __PRIVATE_WebChannelConnection.u_ = !0;
	}
	Go(e, t, n, r, i) {
				...
				try {
					switch (_.getLastErrorCode()) {
						...
						case ErrorCode.TIMEOUT:
							__PRIVATE_logDebug(zt$1, `RPC '${e}' ${s} timed out`), o(new FirestoreError(D.DEADLINE_EXCEEDED, "Request time out"));
							break;
	...
	P_(e, t, n) {
		...
		void 0 !== _ && (o.longPollingTimeout = Math.round(1e3 * _)), this.useFetchStreams && (o.useFetchStreams = !0), this.Qo(o.initMessageHeaders, t, n), o.encodeInitMessageHeaders = !0;
		const a = i.join("");
		...
		return __PRIVATE_unguardedEventListen(u, WebChannel.EventType.OPEN, (() => {
			l || (__PRIVATE_logDebug(zt$1, `RPC '${e}' stream ${r} transport opened.`), h.r_());
		})), __PRIVATE_unguardedEventListen(u, WebChannel.EventType.CLOSE, (() => {
			l || (l = !0, __PRIVATE_logDebug(zt$1, `RPC '${e}' stream ${r} transport closed`), h.s_(), this.I_(u));
		})), __PRIVATE_unguardedEventListen(u, WebChannel.EventType.ERROR, ((t) => {
			l || (l = !0, __PRIVATE_logWarn(zt$1, `RPC '${e}' stream ${r} transport errored. Name:`, t.name, "Message:", t.message), h.s_(new FirestoreError(D.UNAVAILABLE, "The operation could not be completed")));
			...
			if (!l) {
				...
				if (s) {
					...
					"NOT_FOUND" === t && i.includes("database") && i.includes("does not exist") && i.includes(this.databaseId.database) && __PRIVATE_logWarn(`Database '${this.databaseId.database}' not found. Please check your project configuration.`), void 0 === n && (n = D.INTERNAL, i = "Unknown error status: " + t + " with message " + s.message), l = !0, h.s_(new FirestoreError(n, i)), u.close();
				} else __PRIVATE_logDebug(zt$1, `RPC '${e}' stream ${r} received:`, n), h.o_(n);
			}
	...
	*/ Qo(e, t, n) {
		super.Qo(e, t, n), this.databaseInfo.apiKey && (e["x-goog-api-key"] = this.databaseInfo.apiKey);
	}
	/**
	* Wrapped for mocking.
	* @protected
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ __PRIVATE_WebChannelConnection.u_ = !1;
/**
...
var __PRIVATE_ExponentialBackoff = class {
	constructor(e, t, n = 1e3, r = 1.5, i = 6e4) {
		this.Di = e, this.timerId = t, this.E_ = n, this.R_ = r, this.A_ = i, this.V_ = 0, this.d_ = null, this.m_ = Date.now(), this.reset();
	}
	/**
	...
	*/ g_(e) {
		...
		r > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${r} ms (base delay: ${this.V_} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`), this.d_ = this.Di.enqueueAfterDelay(this.timerId, r, (() => (this.m_ = Date.now(), e()))), this.V_ *= this.R_, this.V_ < this.E_ && (this.V_ = this.E_), this.V_ > this.A_ && (this.V_ = this.A_);
	}
	y_() {
...
var __PRIVATE_PersistentStream = class {
	constructor(e, t, n, r, i, s, o, _) {
		this.Di = e, this.w_ = n, this.S_ = r, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, this.b_ = 0, this.D_ = null, this.C_ = null, this.stream = null, this.v_ = 0, this.F_ = new __PRIVATE_ExponentialBackoff(e, t);
	}
	/**
...
*/ var __PRIVATE_PersistentListenStream = class extends __PRIVATE_PersistentStream {
	...
	*/ H_(e) {
		...
		t.database = __PRIVATE_getEncodedDatabaseId(this.serializer), t.addTarget = function __PRIVATE_toTarget(e, t) {
			let n;
			const r = t.target;
			if (n = __PRIVATE_targetIsDocumentTarget(r) ? { documents: __PRIVATE_toDocumentsTarget(e, r) } : { query: __PRIVATE_toQueryTarget(e, r).dt }, n.targetId = t.targetId, t.resumeToken.approximateByteSize() > 0) {
...
*/ var __PRIVATE_PersistentWriteStream = class extends __PRIVATE_PersistentStream {
	...
	*/ get X_() {
	...
	j_(e) {
		return __PRIVATE_hardAssert(!!e.streamToken, 31322), this.lastStreamToken = e.streamToken, __PRIVATE_hardAssert(!e.writeResults || 0 === e.writeResults.length, 55816), this.listener.ea();
	}
	onNext(e) {
		__PRIVATE_hardAssert(!!e.streamToken, 12678), this.lastStreamToken = e.streamToken, this.F_.reset();
...
var __PRIVATE_RemoteStoreImpl = class {
	constructor(e, t, n, r, i) {
		this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.Pa = [], this.Ta = /* @__PURE__ */ new Map(), this.Ia = /* @__PURE__ */ new Map(), this.Ea = /* @__PURE__ */ new Map(), this.Ra = new __PRIVATE_TargetIdGenerator(1e3), this.Aa = new __PRIVATE_TargetIdGenerator(1001), this.Va = /* @__PURE__ */ new Set(), this.da = [], this.ma = i, this.ma.Fo(((e) => {
			n.enqueueAndForget((async () => {
				__PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(Ht$1, "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e) {
					const t = __PRIVATE_debugCast(e);
					t.Va.add(4), await __PRIVATE_disableNetworkInternal(t), t.fa.set("Unknown"), t.Va.delete(4), await __PRIVATE_enableNetworkInternal(t);
				}(this));
			}));
...
function __PRIVATE_remoteStoreListen(e, t) {
	...
	n.Ta.set(i, s), __PRIVATE_shouldStartWatchStream(n) ? __PRIVATE_startWatchStream(n) : __PRIVATE_ensureWatchStream(n).x_() && __PRIVATE_sendWatchRequest(n, s);
}
/**
...
*/ function __PRIVATE_remoteStoreUnlisten(e, t) {
	...
	__PRIVATE_logDebug(Ht$1, "remoteStoreUnlisten removing mapping of SDK target ID to remote", t, i), n.Ta.delete(i), n.Ia.delete(t), n.Ea.delete(i), r.x_() && __PRIVATE_sendUnwatchRequest(n, i), 0 === n.Ta.size && (r.x_() ? r.B_() : __PRIVATE_canUseNetwork(n) && n.fa.set("Unknown"));
}
/**
...
*/ function __PRIVATE_sendWatchRequest(e, t) {
	if (e.ga.$e(t.targetId), t.resumeToken.approximateByteSize() > 0 || t.snapshotVersion.compareTo(SnapshotVersion.min()) > 0) {
		...
		if (void 0 === n) return void __PRIVATE_logDebug(Ht$1, "SDK target ID not found for remote ID: " + t.targetId);
...
async function __PRIVATE_onWatchStreamClose(e, t) {
	__PRIVATE_cleanUpWatchStreamState(e), __PRIVATE_shouldStartWatchStream(e) ? (e.fa.la(t), __PRIVATE_startWatchStream(e)) : e.fa.set("Unknown");
}
async function __PRIVATE_onWatchStreamChange(e, t, n) {
	if (e.fa.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause) try {
		...
		await async function __PRIVATE_handleTargetError(e, t) {
			...
			for (const r of t.targetIds) {
				if (e.Ta.has(r)) {
					const t = e.Ea.get(r);
					void 0 !== t && (await e.remoteSyncer.rejectListen(t, n), e.Ia.delete(t), e.Ea.delete(r)), e.Ta.delete(r);
				}
				e.ga.removeTarget(r);
			}
		}(e, t);
		...
		n.compareTo(t) >= 0 && await function __PRIVATE_raiseWatchSnapshot(e, t) {
			...
			n.targetChanges.forEach(((n, r) => {
				...
				const r = e.Ta.get(t);
				if (!r) return;
				e.Ta.set(t, r.withResumeToken(ByteString.EMPTY_BYTE_STRING, r.snapshotVersion)), __PRIVATE_sendUnwatchRequest(e, t);
...
*/ async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
	...
	e.Va.add(1), await __PRIVATE_disableNetworkInternal(e), e.fa.set("Offline"), n || (n = () => __PRIVATE_localStoreGetLastRemoteSnapshotVersion(e.localStore)), e.asyncQueue.enqueueRetryable((async () => {
		__PRIVATE_logDebug(Ht$1, "Retrying IndexedDB access"), await n(), e.Va.delete(1), await __PRIVATE_enableNetworkInternal(e);
	}));
}
/**
...
async function __PRIVATE_onWriteStreamClose(e, t) {
	t && __PRIVATE_ensureWriteStream(e).X_ && await async function __PRIVATE_handleWriteError(e, t) {
		if (function __PRIVATE_isPermanentWriteError(e) {
			return __PRIVATE_isPermanentError(e) && e !== D.ABORTED;
		}(t.code)) {
			const n = e.Pa.shift();
			__PRIVATE_ensureWriteStream(e).N_(), await __PRIVATE_executeWithRecovery(e, (() => e.remoteSyncer.rejectFailedWrite(n.batchId, t))), await __PRIVATE_fillWritePipeline(e);
		}
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
	...
	n.Va.add(3), await __PRIVATE_disableNetworkInternal(n), r && n.fa.set("Unknown"), await n.remoteSyncer.handleCredentialChange(t), n.Va.delete(3), await __PRIVATE_enableNetworkInternal(n);
}
/**
* Toggles the network state when the client gains or loses its primary lease.
*/ async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
	const n = __PRIVATE_debugCast(e);
	t ? (n.Va.delete(2), await __PRIVATE_enableNetworkInternal(n)) : t || (n.Va.add(2), await __PRIVATE_disableNetworkInternal(n), n.fa.set("Unknown"));
}
/**
...
*/ function __PRIVATE_ensureWatchStream(e) {
	return e.pa || (e.pa = function __PRIVATE_newPersistentWatchStream(e, t, n) {
		const r = __PRIVATE_debugCast(e);
		...
		* limitations under the License.
		*/
		t ? (e.pa.N_(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.fa.set("Unknown")) : (await e.pa.stop(), __PRIVATE_cleanUpWatchStreamState(e));
	}))), e.pa;
}
/**
...
*/ function __PRIVATE_ensureWriteStream(e) {
	return e.ya || (e.ya = function __PRIVATE_newPersistentWriteStream(e, t, n) {
		const r = __PRIVATE_debugCast(e);
		...
		t ? (e.ya.N_(), await __PRIVATE_fillWritePipeline(e)) : (await e.ya.stop(), e.Pa.length > 0 && (__PRIVATE_logDebug(Ht$1, `Stopping write stream with ${e.Pa.length} pending writes`), e.Pa = []));
	}))), e.ya;
}
/**
* @license
...
*/ var __PRIVATE_DocumentChangeSet = class {
	...
	track(e) {
		...
		n ? 0 !== e.type && 3 === n.type ? this.wa = this.wa.insert(t, e) : 3 === e.type && 1 !== n.type ? this.wa = this.wa.insert(t, {
			type: n.type,
			doc: e.doc
...
async function __PRIVATE_eventManagerListen(e, t) {
	...
	s ? !s.va() && t.Fa() && (r = 2) : (s = new __PRIVATE_QueryListenersInfo(), r = t.Fa() ? 0 : 1);
	try {
		switch (r) {
			case 0:
	...
	if (n.queries.set(i, s), s.Ca.push(t), t.xa(n.onlineState), s.Da) t.Oa(s.Da) && __PRIVATE_raiseSnapshotsInSyncEvent(n);
}
async function __PRIVATE_eventManagerUnlisten(e, t) {
	...
	if (s) {
		...
		e >= 0 && (s.Ca.splice(e, 1), 0 === s.Ca.length ? i = t.Fa() ? 0 : 1 : !s.va() && t.Fa() && (i = 2));
	}
	switch (i) {
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
	...
	for (const e of t) {
		...
		if (i) {
			for (const t of i.Ca) t.Oa(e) && (r = !0);
			i.Da = e;
		}
	}
...
(Zt = Jt || (Jt = {})).Na = "default", Zt.Cache = "cache";
/**
...
var __PRIVATE_QueryListener = class {
	constructor(e, t, n) {
		this.query = e, this.Ba = t, this.La = !1, this.ka = null, this.onlineState = "Unknown", this.options = n || {};
	}
	/**
	...
	*/ Oa(e) {
		...
		let t = !1;
		return this.La ? this.qa(e) && (this.Ba.next(e), t = !0) : this.Ka(e, this.onlineState) && (this.Ua(e), t = !0), this.ka = e, t;
	}
	onError(e) {
		this.Ba.error(e);
	}
	/** Returns whether a snapshot was raised. */ xa(e) {
		this.onlineState = e;
		let t = !1;
		return this.ka && !this.La && this.Ka(this.ka, e) && (this.Ua(this.ka), t = !0), t;
	}
	Ka(e, t) {
	...
	Ua(e) {
		e = ViewSnapshot.fromInitialDocuments(e.query, e.docs, e.mutatedKeys, e.fromCache, e.hasCachedResults), this.La = !0, this.Ba.next(e);
	}
	Fa() {
...
*/ var __PRIVATE_BundleConverterImpl = class {
	...
	*/ qs(e) {
		return e.metadata.exists ? __PRIVATE_fromDocument(this.serializer, e.document, !1) : MutableDocument.newNoDocument(this.ks(e.metadata.name), this.Ks(e.metadata.readTime));
	}
	Ks(e) {
...
*/ var __PRIVATE_BundleLoader = class {
	constructor(e, t) {
		this.Ga = e, this.serializer = t, this.za = [], this.ja = [], this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = __PRIVATE_bundleInitialProgress(e);
	}
	/**
	...
	*/ Ja(e) {
		...
		if (e.Wa.namedQuery) this.za.push(e.Wa.namedQuery);
			...
			this.ja.push({ metadata: e.Wa.documentMetadata }), e.Wa.documentMetadata.exists || ++t;
	...
	*/ async Za(e) {
		...
		for (const t of this.za) await __PRIVATE_localStoreSaveNamedQuery(e, t, n.get(t.name));
...
*/ var __PRIVATE_View = class {
	constructor(e, t) {
		this.query = e, this.eu = t, this.tu = null, this.hasCachedResults = !1, this.current = !1, this.nu = __PRIVATE_documentKeySet(), this.mutatedKeys = __PRIVATE_documentKeySet(), this.ru = __PRIVATE_newQueryComparator(e), this.iu = new DocumentSet(this.ru);
	}
	/**
	...
	*/ ou(e, t) {
		...
		if (e.inorderTraversal(((e, t) => {
			...
			if (u && c) u.data.isEqual(c.data) ? l !== h && (n.track({
				type: 3,
				doc: c
			}), P = !0) : this.au(u, c) || (n.track({
				type: 2,
				doc: c
			}), P = !0, (_ && this.ru(c, _) > 0 || a && this.ru(c, a) < 0) && (o = !0));
			else !u && c ? (n.track({
				type: 0,
				doc: c
			}), P = !0) : u && !c && (n.track({
	...
	*/
	applyChanges(e, t, n, r) {
		...
		s.sort(((e, t) => function __PRIVATE_compareChangeType(e, t) {
			const order = (e) => {
				switch (e) {
					...
					case 3: return 2;
					case 1: return 0;
					default: return fail(20277, { At: e });
				}
			};
			return order(e) - order(t);
		}(e.type, t.type) || this.ru(e.doc, t.doc))), this.uu(n), r = r ?? !1;
		/**
		* @license
		* Copyright 2020 Google LLC
		*
		...
		*/
		...
		if (this.tu = _, 0 !== s.length || a) return {
			snapshot: new ViewSnapshot(this.query, e.iu, i, s, e.mutatedKeys, 0 === _, a, !1, !!n && n.resumeToken.approximateByteSize() > 0),
			lu: o
		};
		return { lu: o };
	}
	...
	*/ hu(e) {
		return !this.eu.has(e) && !!this.iu.has(e) && !this.iu.get(e).hasLocalMutations;
	}
	/**
	* Updates syncedDocuments, current, and limbo docs based on the given change.
	* Returns the list of changes to which docs are in limbo.
	*/ uu(e) {
		e && (e.addedDocuments.forEach(((e) => this.eu = this.eu.add(e))), e.modifiedDocuments.forEach(((e) => {})), e.removedDocuments.forEach(((e) => this.eu = this.eu.delete(e))), this.current = e.current);
	}
	cu() {
...
*/ var __PRIVATE_SyncEngineImpl = class {
	constructor(e, t, n, r, i, s) {
		this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.Eu = {}, this.Ru = new ObjectMap(((e) => __PRIVATE_canonifyQuery(e)), __PRIVATE_queryEquals), this.Au = /* @__PURE__ */ new Map(), this.Vu = /* @__PURE__ */ new Set(), this.du = new SortedMap(DocumentKey.comparator), this.mu = /* @__PURE__ */ new Map(), this.fu = new __PRIVATE_ReferenceSet(), this.gu = {}, this.pu = /* @__PURE__ */ new Map(), this.yu = __PRIVATE_TargetIdGenerator._r(), this.onlineState = "Unknown", this.wu = void 0;
	}
	get isPrimaryClient() {
		return !0 === this.wu;
	}
...
async function __PRIVATE_syncEngineListen(e, t, n = !0) {
	...
	let i;
	const s = r.Ru.get(t);
	return s ? (r.sharedClientState.addLocalQueryTarget(s.targetId), i = s.view.Tu()) : i = await __PRIVATE_allocateTargetAndMaybeListen(
		r,
		t,
		n,
...
*/ async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
	e.Su = (t, n, r) => async function __PRIVATE_applyDocChanges(e, t, n, r) {
		let i = t.view.ou(n);
		i.Ss && (i = await __PRIVATE_localStoreExecuteQuery(e.localStore, t.query, !1).then((({ documents: e }) => t.view.ou(e, i))));
	...
	const s = await __PRIVATE_localStoreExecuteQuery(e.localStore, t, !0), o = new __PRIVATE_View(t, s.Ls), _ = o.ou(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" !== e.onlineState, i), u = o.applyChanges(_, e.isPrimaryClient, a);
...
/** Stops listening to the query. */ async function __PRIVATE_syncEngineUnlisten(e, t, n) {
	...
	if (s.length > 1) return r.Au.set(i.targetId, s.filter(((e) => !__PRIVATE_queryEquals(e, t)))), void r.Ru.delete(t);
...
*/ async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
	...
	try {
		...
		t.targetChanges.forEach(((e, t) => {
			const r = n.mu.get(t);
			r && (__PRIVATE_hardAssert(e.addedDocuments.size + e.modifiedDocuments.size + e.removedDocuments.size <= 1, 22616), e.addedDocuments.size > 0 ? r.Iu = !0 : e.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r.Iu, 14607) : e.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r.Iu, 42227), r.Iu = !1));
	...
	if (r.isPrimaryClient && 0 === n || !r.isPrimaryClient && 1 === n) {
		...
		r.Ru.forEach(((n, r) => {
			...
			n.queries.forEach(((e, n) => {
				for (const e of n.Ca) e.xa(t) && (r = !0);
			})), r && __PRIVATE_raiseSnapshotsInSyncEvent(n);
...
*/ async function __PRIVATE_syncEngineRejectListen(e, t, n) {
	...
	if (s) {
		...
		await __PRIVATE_syncEngineApplyRemoteEvent(r, new RemoteEvent(SnapshotVersion.min(), /* @__PURE__ */ new Map(), new SortedMap(__PRIVATE_primitiveComparator), e, n)), r.du = r.du.remove(s), r.mu.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r);
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
	...
	if (e.Au.delete(t), e.isPrimaryClient) e.fu.Qr(t).forEach(((t) => {
		e.fu.containsKey(t) || __PRIVATE_removeLimboTarget(e, t);
	}));
}
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
	for (const r of n) if (r instanceof __PRIVATE_AddedLimboDocument) e.fu.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
		...
		__PRIVATE_logDebug(Xt$1, "Document no longer in limbo: " + r.key), e.fu.removeReference(r.key, t);
		e.fu.containsKey(r.key) || __PRIVATE_removeLimboTarget(e, r.key);
	} else fail(19791, { Du: r });
}
function __PRIVATE_trackLimboChange(e, t) {
	const n = t.key, r = n.path.canonicalString();
	e.du.get(n) || e.Vu.has(r) || (__PRIVATE_logDebug(Xt$1, "New document in limbo: " + n), e.Vu.add(r), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
/**
...
async function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
	...
	if (!n.currentUser.isEqual(t)) {
		...
		}(n, "'waitForPendingWrites' promise is rejected due to a user change."), n.sharedClientState.handleUserChange(t, e.removedBatchIds, e.addedBatchIds), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e.Os);
	}
}
...
*/ async function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
	const n = __PRIVATE_debugCast(e), r = await __PRIVATE_localStoreExecuteQuery(n.localStore, t.query, !0), i = t.view.Pu(r);
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
	const i = __PRIVATE_debugCast(e), s = await function __PRIVATE_localStoreLookupMutationDocuments(e, t) {
		...
		return n.persistence.runTransaction("Lookup mutation documents", "readonly", ((e) => r.Zn(e, t).next(((t) => t ? n.localDocuments.getDocuments(e, t) : PersistencePromise.resolve(null)))));
	}(i.localStore, t);
	null !== s ? ("pending" === n ? await __PRIVATE_fillWritePipeline(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (__PRIVATE_processUserCallback(i, t, r || null), __PRIVATE_triggerPendingWritesCallbacks(i, t), function __PRIVATE_localStoreRemoveCachedMutationBatchMetadata(e, t) {
		__PRIVATE_debugCast(__PRIVATE_debugCast(e).mutationQueue).tr(t);
	}(i.localStore, t)) : fail(6720, "Unknown batchState", { Cu: n }), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(i, s)) : __PRIVATE_logDebug(Xt$1, "Cannot apply mutation batch with id: " + t);
}
/** Applies a query target change from a different tab. */
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
	const n = __PRIVATE_debugCast(e);
	if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), !0 === t && !0 !== n.wu) {
		const t = await __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(n, n.sharedClientState.getAllActiveQueryTargets().toArray());
		n.wu = !0, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, !0);
		...
		n.Au.forEach(((r, i) => {
			...
			})), t.fu.Gr(), t.mu = /* @__PURE__ */ new Map(), t.du = new SortedMap(DocumentKey.comparator);
		}(n), n.wu = !1, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, !1);
	}
}
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
	...
	for (const e of t) {
		...
		if (n && 0 !== n.length) {
			...
			for (const e of n) {
				const n = await __PRIVATE_synchronizeViewAndComputeSnapshot(r, r.Ru.get(e));
...
function __PRIVATE_syncEngineGetActiveClients(e) {
	return function __PRIVATE_localStoreGetActiveClients(e) {
		return __PRIVATE_debugCast(__PRIVATE_debugCast(e).persistence).ls();
	}(__PRIVATE_debugCast(e).localStore);
}
/** Applies a query target change from a different tab. */
async function __PRIVATE_syncEngineApplyTargetState(e, t, n, r) {
	const i = __PRIVATE_debugCast(e);
	if (i.wu) return void __PRIVATE_logDebug(Xt$1, "Ignoring unexpected query state notification.");
	const s = i.Au.get(t);
...
/** Adds or removes Watch targets for queries from different tabs. */ async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
	...
	if (r.wu) {
		for (const e of t) {
			if (r.Au.has(e) && r.sharedClientState.isActiveQueryTarget(e)) {
		...
		for (const e of n) r.Au.has(e) && await __PRIVATE_localStoreReleaseTarget(r.localStore, e, !1).then((() => {
...
async function __PRIVATE_loadBundleImpl(e, t, n) {
		try {
			...
			if (await function __PRIVATE_localStoreHasNewerBundle(e, t) {
				...
				return n.persistence.runTransaction("hasNewerBundle", "readonly", ((e) => n.hi.getBundleMetadata(e, t.id))).then(((e) => !!e && e.createTime.compareTo(r) >= 0));
			...
			let s = await t.vu();
			for (; s;) {
				const e = await i.Ja(s);
				e && n._updateProgress(e), s = await t.vu();
			}
			const o = await i.Za(e.localStore);
			return await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, o.Ya, void 0), await function __PRIVATE_localStoreSaveBundle(e, t) {
				const n = __PRIVATE_debugCast(e);
				return n.persistence.runTransaction("Save bundle", "readwrite", ((e) => n.hi.saveBundleMetadata(e, t)));
			}(e.localStore, r), n._completeWith(o.progress), Promise.resolve(o.Xa);
		} catch (e) {
...
*/ var __PRIVATE_IndexedDbOfflineComponentProvider = class extends __PRIVATE_MemoryOfflineComponentProvider {
	constructor(e, t, n) {
		super(), this.Bu = e, this.cacheSizeBytes = t, this.forceOwnership = n, this.kind = "persistent", this.synchronizeTabs = !1;
	}
	async initialize(e) {
		await super.initialize(e), await this.Bu.initialize(this, e), await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Bu.syncEngine), await __PRIVATE_fillWritePipeline(this.Bu.remoteStore), await this.persistence.Gi((() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve())));
	}
	xu(e) {
		return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
	}
...
*/ var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
	constructor(e, t) {
		super(e, t, !1), this.Bu = e, this.cacheSizeBytes = t, this.synchronizeTabs = !0;
	}
	async initialize(e) {
		...
		}, await this.sharedClientState.start()), await this.persistence.Gi((async (e) => {
			await __PRIVATE_syncEngineApplyPrimaryState(this.Bu.syncEngine, e), this.gcScheduler && (e && !this.gcScheduler.started ? this.gcScheduler.start() : e || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e || this.indexBackfillerScheduler.stop());
		}));
	}
	Fu(e) {
...
*/ var OnlineComponentProvider = class {
	...
	async terminate() {
		await async function __PRIVATE_remoteStoreShutdown(e) {
			const t = __PRIVATE_debugCast(e);
			__PRIVATE_logDebug(Ht$1, "RemoteStore shutting down."), t.Va.add(5), await __PRIVATE_disableNetworkInternal(t), t.ma.shutdown(), t.fa.set("Unknown");
...
*/ var __PRIVATE_BundleReaderImpl = class {
	constructor(e, t) {
		this.qu = e, this.serializer = t, this.metadata = new __PRIVATE_Deferred(), this.buffer = new Uint8Array(), this.Ku = function __PRIVATE_newTextDecoder() {
			return new TextDecoder("utf-8");
		}(), this.Uu().then(((e) => {
			e && e.Qa() ? this.metadata.resolve(e.Wa.metadata) : this.metadata.reject(/* @__PURE__ */ new Error(`The first element of the bundle is not a metadata, it is\n             ${JSON.stringify(e?.Wa)}`));
	...
	*/ async Uu() {
	...
	/** First index of '{' from the underlying buffer. */ Gu() {
	...
	*/ async $u() {
		for (; this.Gu() < 0;) if (await this.zu()) break;
	...
	*/ async Qu(e) {
		for (; this.buffer.length < e;) await this.zu() && this.Wu("Reached the end of bundle when more is expected.");
...
var Transaction$2 = class {
	...
	async lookup(e) {
		...
		const t = await async function __PRIVATE_invokeBatchGetDocumentsRpc(e, t) {
			const n = __PRIVATE_debugCast(e), r = { documents: t.map(((e) => __PRIVATE_toName(n.serializer, e))) }, i = await n.zo("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r, t.length), s = /* @__PURE__ */ new Map();
			i.forEach(((e) => {
	...
	recordVersion(e) {
		...
		if (e.isFoundDocument()) t = e.version;
			...
			if (!e.isNoDocument()) throw fail(50498, { Ju: e.constructor.name });
...
*/ var __PRIVATE_TransactionRunner = class {
	constructor(e, t, n, r, i) {
		this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r, this.deferred = i, this.Hu = n.maxAttempts, this.F_ = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry");
	}
	...
	Xu() {
		this.F_.g_((async () => {
			const e = new Transaction$2(this.datastore), t = this.Yu(e);
			t && t.then(((t) => {
...
/** Enables the network connection and re-enqueues all pending operations. */ function __PRIVATE_firestoreClientEnableNetwork(e) {
	return e.asyncQueue.enqueue((async () => {
		...
		return t.setNetworkEnabled(!0), function __PRIVATE_remoteStoreEnableNetwork(e) {
			const t = __PRIVATE_debugCast(e);
			return t.Va.delete(0), __PRIVATE_enableNetworkInternal(t);
		}(n);
	}));
}
/** Disables the network connection. Pending operations will not complete. */ function __PRIVATE_firestoreClientDisableNetwork(e) {
	return e.asyncQueue.enqueue((async () => {
		...
		return t.setNetworkEnabled(!1), async function __PRIVATE_remoteStoreDisableNetwork(e) {
			const t = __PRIVATE_debugCast(e);
			t.Va.add(0), await __PRIVATE_disableNetworkInternal(t), t.fa.set("Offline");
		}(n);
	}));
}
/**
...
function __PRIVATE_firestoreClientGetDocumentsFromLocalCache(e, t) {
	...
	return e.asyncQueue.enqueueAndForget((async () => async function __PRIVATE_executeQueryFromCache(e, t, n) {
		try {
			const r = await __PRIVATE_localStoreExecuteQuery(e, t, !0), i = new __PRIVATE_View(t, r.Ls), s = i.ou(r.documents), o = i.applyChanges(s, !1);
	...
	return e.asyncQueue.enqueueAndForget((async () => {
		try {
			...
			r.resolve(async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
				const r = __PRIVATE_debugCast(e), { request: i, ft: s, parent: o } = __PRIVATE_toRunAggregationQueryRequest(r.serializer, __PRIVATE_queryToAggregateTarget(t), n);
				r.connection.ko || delete i.parent;
				const _ = (await r.zo("RunAggregationQuery", r.serializer.databaseId, o, i, 1)).filter(((e) => !!e.result));
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
	...
	return e.asyncQueue.enqueueAndForget((async () => function __PRIVATE_addSnapshotsInSyncListener(e, t) {
		__PRIVATE_debugCast(e).Ma.add(t), t.next();
		...
		n.ku(), e.asyncQueue.enqueueAndForget((async () => function __PRIVATE_removeSnapshotsInSyncListener(e, t) {
			__PRIVATE_debugCast(e).Ma.delete(t);
		}(await __PRIVATE_getEventManager(e), n)));
	};
}
/**
...
function __PRIVATE_firestoreClientGetNamedQuery(e, t) {
	return e.asyncQueue.enqueue((async () => function __PRIVATE_localStoreGetNamedQuery(e, t) {
		const n = __PRIVATE_debugCast(e);
		return n.persistence.runTransaction("Get named query", "readonly", ((e) => n.hi.getNamedQuery(e, t)));
...
var __PRIVATE_AsyncQueueImpl = class {
	constructor(e = Promise.resolve()) {
		this.nc = [], this.rc = !1, this.sc = [], this.oc = null, this._c = !1, this.ac = !1, this.uc = [], this.F_ = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry"), this.cc = () => {
			const e = getDocument();
			e && __PRIVATE_logDebug(sn, "Visibility state changed to " + e.visibilityState), this.F_.y_();
		}, this.lc = e;
		const t = getDocument();
	...
	*/ async Tc() {
	...
	Pc(e) {
		const t = this.lc.then((() => (this._c = !0, e().catch(((e) => {
			this.oc = e, this._c = !1;
	...
	enqueueAfterDelay(e, t, n) {
		this.hc(), this.uc.indexOf(e) > -1 && (t = 0);
		const r = DelayedOperation.createAndSchedule(this, e, t, n, ((e) => this.Ic(e)));
		return this.sc.push(r), r;
	}
	hc() {
		this.oc && fail(47125, { Ec: __PRIVATE_getMessageOrStack(this.oc) });
	}
	...
	* exists.
	*/ Ac(e) {
		for (const t of this.sc) if (t.timerId === e) return !0;
		return !1;
	}
	/**
...
/** A "context" object passed around while parsing user data. */ var __PRIVATE_ParseContextImpl = class __PRIVATE_ParseContextImpl {
	...
	*/
	constructor(e, t, n, r, i, s) {
		this.settings = e, this.databaseId = t, this.serializer = n, this.ignoreUndefinedProperties = r, void 0 === i && this.mc(), this.fieldTransforms = i || [], this.fieldMask = s || [];
	}
	get path() {
...
var __PRIVATE_ArrayUnionFieldValueImpl = class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), r = new __PRIVATE_ArrayUnionTransformOperation(this.Cc.map(((e) => __PRIVATE_parseData(e, t))));
...
var __PRIVATE_ArrayRemoveFieldValueImpl = class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), r = new __PRIVATE_ArrayRemoveTransformOperation(this.Cc.map(((e) => __PRIVATE_parseData(e, t))));
		return new FieldTransform(e.path, r);
	}
	isEqual(e) {
...
var __PRIVATE_NumericMinimumFieldValueImpl = class __PRIVATE_NumericMinimumFieldValueImpl extends FieldValue {
	...
	isEqual(e) {
		return e instanceof __PRIVATE_NumericMinimumFieldValueImpl && (this.vc === e.vc || Number.isNaN(this.vc) && Number.isNaN(e.vc));
	}
};
var __PRIVATE_NumericMaximumFieldValueImpl = class __PRIVATE_NumericMaximumFieldValueImpl extends FieldValue {
	...
	isEqual(e) {
		return e instanceof __PRIVATE_NumericMaximumFieldValueImpl && (this.vc === e.vc || Number.isNaN(this.vc) && Number.isNaN(e.vc));
	}
};
...
*/ function __PRIVATE_fieldPathFromDotSeparatedString(e, t, n) {
	if (t.search(an) >= 0) throw __PRIVATE_createError(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`, e, !1, void 0, n);
	try {
...
//#endregion
//#region ../../../../node_modules/.pnpm/@firebase+firestore@4.15.0_@firebase+app@0.14.13/node_modules/@firebase/firestore/dist/index.esm.js
var Ut = "@firebase/firestore", Ht = "4.15.0";
/**
* @license
* Copyright 2017 Google LLC
*
